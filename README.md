...
## RISC-V Multi Cycle CPU Block Diagram
<img width="700" height="637" alt="Image" src="https://github.com/user-attachments/assets/4565e8ce-4b8f-4141-b819-7f30ef426c1d" />
<br>
...
##### - Cycle 4 - MEM (Load/Store만 해당): ALUOut의 주소를 사용해 데이터 메모리에 접근합니다. Load는 읽은 값을 MDR(Memory Data Register)에 저장하고, Store는 메모리에 쓴다.
##### - Cycle 5 - WB (Register write 명령어만 해당): ALUOut 또는 MDR의 값을 레지스터 파일의 rd에 쓴다.
<br>
